...
import '../services/compatibility_certificate_pdf.dart';
...
<<<<<<< HEAD
=======
  // Cached alongside _pdfFile so "Download PDF" can also hand the same
  // already-generated bytes to file_saver (the phone's public Downloads/
  // Files location) without regenerating the PDF a second time.
>>>>>>> 6a38f9611607f890fb87e4e50f7f6f3cde3f99ca
    ...
    try {
      ...
      setState(() {
        ...
        _error = e is ApiException
            ? e.message
            : AppLocalizations.of(context).compDashboardLoadError;
        _loading = false;
      });
    }
  }
  ...
  Future<File> _ensurePdf(CompatibilityReport report, String myName, String otherName) async {
    ...
    // profileAId is always the signed-in caller in this app's usage — see
    // CompatibilityReport's doc comment — so traditionalRoleA tells us
    ...
    final bytes = await buildCompatibilityCertificateBytes(
      report: report,
      brideName: brideName,
      groomName: groomName,
...
=======
      ...
      final publicPath = await savePublicCompatibilityPdf(bytes: _pdfBytes!, person1Name: myName, person2Name: otherName);
      if (!mounted) return;
      ...
      unawaited(DownloadNotificationService.instance.notifyDownloaded(
...
>>>>>>> 6a38f9611607f890fb87e4e50f7f6f3cde3f99ca
  ...
  Widget _content(CompatibilityReport report, String myName, String otherName, AppLocalizations t) {
    ...
    return ListView(
      ...
      children: [
        ...
        _pdfActionsRow(report, myName, otherName, t),
        const SizedBox(height: 14),
  ...
  Widget _detailedReportButton(String otherName, AppLocalizations t) {
    return SizedBox(
      height: 48,
